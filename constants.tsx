...
export const PACKAGES: Package[] = [
  ...
  { 
    ...
    itinerary: [
      { day: 1, title: 'Bangkok Arrival', activities: 'One Way Transfer from Bangkok Airport to Pattaya hotel & Check-IN to Hotel at 2PM - Before 2 PM check-in Please Book Early Check-in', hotel: 'Mountain Beach Resort or similar' },
