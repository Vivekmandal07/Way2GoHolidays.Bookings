      ...
      <div className="relative bg-white w-full max-w-md rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in duration-500">
        ...
        <div className="bg-gradient-to-br from-blue-700 to-blue-900 p-12 text-center text-white relative">
          ...
          <div className="inline-block bg-white/10 backdrop-blur-md px-4 py-1 rounded-full border border-white/20">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-90 tracking-widest">Free for Everyone</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          ...
          <div className="space-y-4">
            <button 
              type="submit"
              className="w-full bg-blue-700 text-white py-5 rounded-[2rem] font-black text-base uppercase tracking-[0.2em] shadow-2xl shadow-blue-200 hover:bg-blue-800 transition-all active:scale-[0.98] animate-glow-pulse"
            >
              {isRegister ? 'Join Free Today' : 'Enter Dashboard'}
            </button>
          </div>
