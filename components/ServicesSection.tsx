            ...
            <form onSubmit={onSubmit} className="grid gap-3 lg:grid-cols-5 items-end">
              ...
              <div className="lg:col-span-5 grid grid-cols-12 gap-3 items-end">
                ...
                <div className="col-span-1 sm:col-span-2 flex items-end justify-end">
                  <button type="submit" className="inline-flex h-8 min-w-[190px] items-center justify-center rounded-xl bg-blue-600 px-6  text-lg font-bold text-white shadow-lg shadow-blue-500/20 transition hover:bg-blue-700">
                    Search Hotels
                  </button>
                </div>
              </div>
