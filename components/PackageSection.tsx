              ...
              <div className="mt-auto pt-6 border-t border-slate-50">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="group/btn bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 hover:scale-105 transition-all duration-300 text-xs font-black uppercase tracking-wider shadow-lg active:scale-95 flex items-center gap-2"
                  >
                    <span className="transition-transform duration-300 group-hover/btn:scale-110">View Details</span>
